		...
		*/
		...
		if (src != null) {
			...
			if (ratio <= 1) {
				 ...
				 * targetWidth.
				 */
				targetHeight = (int)((float) targetWidth * ratio + 0.5f);
				 ...
				 */
				targetWidth = (int)((float) targetHeight / ratio + 0.5f);
//				targetWidth = Math.round((float) targetHeight / ratio);
	...
	protected static BufferedImage scaleImage(BufferedImage src,
		 ...
		 * http://code.google.com/p/java-image-scaling/source/browse/trunk/src/main
