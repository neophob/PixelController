...
public class Scalr42 {
	...
	public static BufferedImage resize(BufferedImage src, Method scalingMethod,
		...
		if (scalingMethod == Scalr42.Method.AUTOMATIC)
		...
		if (scalingMethod == Scalr42.Method.SPEED) {
			result = scaleImage(src, targetWidth, targetHeight,
					RenderingHints.VALUE_INTERPOLATION_NEAREST_NEIGHBOR);
		} else if (scalingMethod == Scalr42.Method.BALANCED) {
			result = scaleImage(src, targetWidth, targetHeight,
					RenderingHints.VALUE_INTERPOLATION_BILINEAR);
		} else if (scalingMethod == Scalr42.Method.QUALITY
				|| scalingMethod == Scalr42.Method.ULTRA_QUALITY) {
			/*
	...
	protected static void log(int depth, String message, Object... params) {
		if (Scalr42.DEBUG) {
			System.out.print(Scalr42.LOG_PREFIX);
	...
	protected static Method determineScalingMethod(int targetWidth,
		...
		if (length <= Scalr42.THRESHOLD_QUALITY_BALANCED)
			result = Method.QUALITY;
		else if (length <= Scalr42.THRESHOLD_BALANCED_SPEED)
