...
/**
 * Minimum Mixer, the the lower value
 */
public class Minimum extends Mixer {
     ...
     */
    public Minimum(PixelControllerMixer controller) {
        super(controller, MixerName.MINIMUM, ResizeName.QUALITY_RESIZE);
    }
