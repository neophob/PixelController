...
public class FileUtilsLocalImpl implements FileUtils {
    ...
    private static final transient String BML_DIR = DATA_DIR + File.separator + "blinken"
            + File.separator;
    ...
    /**
     * get files by extension not recursive
     * 
     * @param path
     * @param ff
     * @return
    ...
    private class BlinkenlightsFilter implements FilenameFilter {
        public boolean accept(File dir, String name) {
            return name.toLowerCase().endsWith(".bml") || name.toLowerCase().endsWith(".bml.gz");
        }
    }
