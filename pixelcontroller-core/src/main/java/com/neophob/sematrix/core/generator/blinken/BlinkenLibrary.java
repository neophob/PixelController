...
package com.neophob.sematrix.core.generator.blinken;
...
import com.neophob.sematrix.core.generator.blinken.jaxb.Blm;
import com.neophob.sematrix.core.generator.blinken.jaxb.Header;
...
public class BlinkenLibrary {
	...
	public BlinkenLibrary() {
		try {
			JAXBContext context = JAXBContext.newInstance("com.neophob.sematrix.core.generator.blinken.jaxb");
