...
public class PixelImage extends Generator {
    ...
    public PixelImage(MatrixData matrix, ISound sound, float fps) throws InvalidParameterException {
        ...
        /*
         * gelesen von der mitte! 1010 .... -> 0xa -> 0xacaf .. ganz rechts (F)
         * ist oben 1100 .... -> 0xc 1010 .... -> 0xa 1111 .... -> 0xf
         * 
         * 1101 .... -> 0xd ->0x45d9 0101 .... -> 0x5 0100 .... -> 0x4 0110 ....
         * -> 0x6
         */
        ...
        LOG.log(Level.INFO, "PixelImage resize value {0}/{1} [{2}/{3}]", new Integer[] { xDiff,
                yDiff, xDiff * PIXELNR, yDiff * PIXELNR });
    }
