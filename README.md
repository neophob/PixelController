...
**BBB**: Beagle Bone Black, ARMv7 Processor rev 2 (v7l), 300 BogoMIPS, **JRE**: 1.7.0_51-b13
Kernel: `Linux beaglebone 3.8.13 #1 SMP Thu Sep 12 10:27:06 CEST 2013 armv7l GNU/Linux`

**RPi**: Raspberry Pi, Model B, 512MB Ram, ARMv6-compatible processor rev 7 (v6l), **JRE**: 1.7.0_40-b43
Kernel: `Linux raspberrypi 3.10.27+ #630 PREEMPT Fri Jan 17 19:44:36 GMT 2014 armv6l GNU/Linux`

**OSX**: Machine: MacBook Air, 2x1.8GHz i5, **JRE**: 1.7.0_21-b12 
